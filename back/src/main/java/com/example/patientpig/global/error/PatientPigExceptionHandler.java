...
public class PatientPigExceptionHandler {

    @ResponseStatus(value = HttpStatus.CONFLICT)
    @ExceptionHandler(PatientPigException.class)
    public ErrorResponse handlePatientPigException(PatientPigException e, HttpServletRequest request) {
